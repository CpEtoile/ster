...
from .cli_files_picker import (
    arrow_file_picker,
    collect_checked_paths,
    fallback_file_picker,
    format_picker_item_label,
    handle_digit_key,
    handle_esc_seq,
    is_toggleable_file,
    parse_comma_selection,
    parse_file_picker_choice,
    parse_numeric_picker_choice,
    pick_file_interactive,
    print_fallback_options,
    process_picker_key,
)
...
_parse_numeric_picker_choice = parse_numeric_picker_choice
_parse_file_picker_choice = parse_file_picker_choice
_print_fallback_options = print_fallback_options
_fallback_file_picker = fallback_file_picker
...
def _pick_file_interactive(
    ...
    return pick_file_interactive(
        files,
        preselect=preselect,
        quit_sentinel=_QUIT_SENTINEL,
        arrow_picker_fn=globals()["_arrow_file_picker"],
    )


_is_toggleable_file = is_toggleable_file
_collect_checked_paths = collect_checked_paths
_format_picker_item_label = format_picker_item_label
_handle_esc_seq = handle_esc_seq
_handle_digit_key = handle_digit_key
_process_picker_key = process_picker_key
_arrow_file_picker = arrow_file_picker
